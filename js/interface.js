Interface = (function() {
  ...
  function displayLoginInterface(rooms, components) {
    ...
    var widget = "<div id='netlogo-monitor-"+index+"' class='netlogo-widget netlogo-monitor netlogo-output login-widget'"+
    ...
    index++;
    widget = "<div id='netlogo-monitor-"+index+"' class='netlogo-widget netlogo-monitor netlogo-output login-widget'"+
    ...
    index++;
    widget = "<label id='netlogo-inputBox-"+index+"' class='netlogo-widget netlogo-input-box netlogo-input login-widget'"+
    ...
    index++;
    widget = "<button id='netlogo-button-"+index+"'class='netlogo-widget netlogo-button netlogo-command login-widget'"+
    ...
    widget = "<div class='netlogo-widget room-button-container login-widget' style='background-color: white; overflow: scroll;"+
    ...
    for (var i=0; i<rooms.length; i++) {
      // a room button
      index++;
      widget = "<button id='netlogo-button-"+index+"'class='netlogo-widget netlogo-command login-widget'"+
